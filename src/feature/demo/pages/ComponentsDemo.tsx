    ...
    <div className="container-govco py-4">
      <div className="d-flex flex-column gap-4">
        ...
        <Card variant="elevated">
          ...
          />
          <CardContent>
            <p className="mb-0" style={{ color: 'var(--color-govco-gris)' }}>
        ...
        <Card>
          ...
          <CardContent>
            <div className="d-flex flex-column gap-4">
              {/* Variantes */}
              <div>
                <h4 className="small fw-semibold mb-3" style={{ color: 'var(--color-govco-gris-oscuro)' }}>
                  Variantes
                </h4>
        ...
        <Card>
          ...
          <CardContent>
            <div className="d-flex flex-column gap-4">
              ...
              {/* Radio Group */}
              <div>
                <p className="small fw-medium mb-2" style={{ color: 'var(--color-govco-gris-oscuro)' }}>
            ...
            <div className="row g-3">
              <div className="col-md-4">
                <Card variant="default">
                  <CardContent>
                    <h4 className="fw-semibold mb-2" style={{ color: 'var(--color-govco-marino)' }}>
                      Card Default
                    </h4>
              ...
              <div className="col-md-4">
                <Card variant="outlined">
                  <CardContent>
                    <h4 className="fw-semibold mb-2" style={{ color: 'var(--color-govco-verde)' }}>
                      Card Outlined
                    </h4>
                    <p className="small mb-0" style={{ color: 'var(--color-govco-gris)' }}>
              ...
              <div className="col-md-4">
                <Card variant="elevated">
                  <CardContent>
                    <h4 className="fw-semibold mb-2" style={{ color: 'var(--color-govco-rojo)' }}>
                      Card Elevated
                    </h4>
                    <p className="small mb-0" style={{ color: 'var(--color-govco-gris)' }}>
                      Card con sombra
